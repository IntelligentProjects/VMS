...
export class HomeThreePage implements OnInit {
  ...
  constructor(public menuCtrl: MenuController, private service: CustomThemeService, public shared: SharedDataService, public nav: NavController,public productService: ProductService, public cartService: CartService, public router: Router)
   {
    setTimeout(() => {
      // this.newestItems = [
      ...
      console.log('newest array',this.newestItems);  //[{},{},{},{},{},{}]
  ...
  getData(){
    this.productService.getliveData().subscribe(resp => {
      ...
      var ids = [];
     for(let result of jsonobject){
      this.newestItems=result['cat_products'];
      }
    });
    //this.searchChanged();
  }
...
//   goToProductsPage(extras) {
//   console.log('extras',extras['id']);
//  this.nav.navigateForward('/dashboard/3');
//   }
