...
export class ContactUsPage implements OnInit {
  ...
  constructor(private service: CustomThemeService,public menuCtrl: MenuController,
    public appEventsService: AppEventsService, public shared: SharedDataService, public config: ConfigService, translate: TranslateService, public nav: NavController) { 
